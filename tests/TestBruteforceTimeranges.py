...
from definitions.predicates import bruteforce_timeranges, available, have_time
...
class TestBruteForceTimeranges(TestCase):
    ...
    def test_bruteforce_timeranges__should_return_correctly_on_zero_timerange(self):
