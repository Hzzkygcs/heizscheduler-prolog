...
from definitions.operators import deprecated_time_range, time_point
...
class TestDuration(TestCase):
    ...
    def test__should_return_correctly(self):
        ...
        query = duration(
            deprecated_time_range(temp1, temp2),
            X
        )
    ...
    def test__should_return_zero_if_the_same(self):
        result = self.prolog.query(duration(
            deprecated_time_range(time_point(2, 20), time_point(2, 20)),
            X
        ))
