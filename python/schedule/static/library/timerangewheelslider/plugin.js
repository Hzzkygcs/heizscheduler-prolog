...
;( function( $, window, document, d3, undefined ) {
	...
	"use strict";
		...
		function Plugin ( element, options ) {
			...
			window.timerangewheelslider = this;
			window.timerangewheelslider.plugin = Plugin;
			this.init();
		}
		...
		$.extend( Plugin.prototype, {
			...
			helper: {
				...
				getData: function() {
					console.log(this.graphdata[0], this.graphdata[1]);
...
//https://amdevblog.wordpress.com/2016/07/20/update-d3-js-scripts-from-v3-to-v4/
				...
				window.timerangewheelslider.updateData = (start, end) => {
					while (this.helper.graphdata.length > 0){
						this.helper.graphdata.pop();
					}
					this.helper.calculateKnobInitialData({start: start, end: end});
