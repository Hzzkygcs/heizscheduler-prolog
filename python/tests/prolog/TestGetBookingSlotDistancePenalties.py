...
class TestGetBookingSlotDistancePenalties(TestCase):
    ...
    # for this testing, duration wont be important
    ...
    def test__should_return_empty_list_for_one_item(self):
        result = self.prolog.query(get_booking_slot_distance_penalties(
            [self.get_booked_slot(10, 5)], Result
        ))
        result = get(self, result, Result)
        self.assertEqual([], result)
    ...
    def test__two_item__zero_penalty(self):
        result = self.prolog.query(get_booking_slot_distance_penalties(
            [self.get_booked_slot(10, 5), 
             self.get_booked_slot(MINUTE_DIFFERENCE_NO_PENALTY_LESS_THAN_10, 5)], Result
        ))
        result = get(self, result, Result)
    ...
    def test_two_item__4_penalty(self):
        result = self.prolog.query(get_booking_slot_distance_penalties(
            [self.get_booked_slot(10, 5),
             self.get_booked_slot(MINUTE_DIFFERENCE_TO_CAUSE_FOUR_PENALTY, 5)], Result
        ))
        result = get(self, result, Result)
    ...
    def test__two_item__3_penalty(self):
        result = self.prolog.query(get_booking_slot_distance_penalties(
            [self.get_booked_slot(10, 5),
             self.get_booked_slot(MINUTE_DIFFERENCE_TO_CAUSE_THREE_PENALTY, 5)], Result
        ))
        result = get(self, result, Result)
    ...
    def test__two_item__2_penalty(self):
        result = self.prolog.query(get_booking_slot_distance_penalties(
            [self.get_booked_slot(10, 5),
             self.get_booked_slot(MINUTE_DIFFERENCE_TO_CAUSE_TWO_PENALTY, 5)], Result
        ))
        result = get(self, result, Result)
    ...
    def test__two_item__1_penalty(self):
        result = self.prolog.query(get_booking_slot_distance_penalties(
            [self.get_booked_slot(10, 5),
             self.get_booked_slot(MINUTE_DIFFERENCE_TO_CAUSE_ONE_PENALTY, 5)], Result
        ))
        result = get(self, result, Result)
    ...
    def test__two_item__zero_penalty__more_than_two_hour(self):
        result = self.prolog.query(get_booking_slot_distance_penalties(
            [self.get_booked_slot(10, 5),
             self.get_booked_slot(MINUTE_DIFFERENCE_NO_PENALTY_MORE_THAN_120, 5)], Result
        ))
        result = get(self, result, Result)
        self.assertEqual([0], result)
    ...
    def test__multiple_item(self):
        result = self.prolog.query(get_booking_slot_distance_penalties(
            [self.get_booked_slot(10, 5),
             self.get_booked_slot(MINUTE_DIFFERENCE_TO_CAUSE_FOUR_PENALTY, 10),
             self.get_booked_slot(MINUTE_DIFFERENCE_NO_PENALTY_MORE_THAN_120, 10),
             self.get_booked_slot(MINUTE_DIFFERENCE_TO_CAUSE_ONE_PENALTY, 10),
             self.get_booked_slot(MINUTE_DIFFERENCE_TO_CAUSE_THREE_PENALTY, 10),
             self.get_booked_slot(MINUTE_DIFFERENCE_NO_PENALTY_LESS_THAN_10, 10),
             self.get_booked_slot(MINUTE_DIFFERENCE_TO_CAUSE_TWO_PENALTY, 10),
             ], Result
        ))
        result = get(self, result, Result)
